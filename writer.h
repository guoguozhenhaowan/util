...
class Writer{
        ...
        gzFile zipfile;       ///< gzFile file handler
        std::ofstream* ofs;   ///< pointer to ofstream
        bool zipped;          ///< output file is zipped or not
        int compressLevel;    ///< compression level for gz file
        bool needClose;       ///< needed to be closed or not
    ...
    public:
        ...
        /** Whether the output file is zipped or not
